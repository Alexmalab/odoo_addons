...
<odoo>
      <data noupdate="1">
            ...
            <record id="crm_case_partner_assign_1" model="crm.lead">
                  ...
                  <field name="tag_ids" eval="[(6, 0, [ref('crm.categ_oppor1')])]"/>
...
## File: data\crm_partner_assign_data.xml
...
<odoo>
        ...
        <record model="res.partner" id="base.res_partner_2">
            <field name="assigned_partner_id" eval="ref('base.res_partner_3')"/>
        </record>
       <record id="base.res_partner_4" model="res.partner">
        ...
        <record model="res.partner" id="base.res_partner_2">
            <field name="assigned_partner_id" eval="ref('base.res_partner_1')"/>
        </record>
        <record model="res.partner" id="base.res_partner_4">
...
<odoo>
       ...
       <record id="view_report_crm_partner_assign_graph" model="ir.ui.view">
            ...
            <field name="model">crm.partner.report.assign</field>
            <field name="arch" type="xml">
                <graph string="Opportunities Assignment Analysis" stacked="True">
