...
## File: data\forum_default_faq.html
        ...
        <record id="view_forum_post_search" model="ir.ui.view">
            ...
            <field name="arch" type="xml">
                <search string="Search in Post">
                    ...
                    <filter string="Answered Questions" name="answered_questions" domain="[('child_count', '!=', 0), ('parent_id', '=', False)]" />
                    <separator/>
                    <filter string="Archived" name="inactive" domain="[('active','=',False)]"/>
                        ...
                        <div class="col">
                            <nav t-if="header.get('is_guidelines') or queue_type or new_question or is_edit or tags or reasons" aria-label="breadcrumb">
                                <ol class="breadcrumb p-0 bg-white">
                                    ...
                                    <li t-if="header.get('is_guidelines')" class="breadcrumb-item">Guidelines</li>
                                    ...
                                    <li t-if="new_question" class="breadcrumb-item">Ask a Question</li>
                                    <t t-if="is_edit">
                                        <t t-set="target" t-value="post.parent_id if is_answer else post"/>
                                        <li class="breadcrumb-item text-truncate" style="max-width:150px">
                                            <a t-attf-href="/forum/#{ slug(forum) }/question/#{ slug(target)}" title="Back to Question">
                                                <t t-esc="target.name"/>
                                            </a>
                                        </li>
            ...
            <ul class="navbar-nav d-lg-none flex-row flex-grow-1 justify-content-between">
                ...
                <li class="nav-item dropdown mr-auto">
                    <a class="nav-link active dropdown-toggle" type="button" data-toggle="dropdown">
                        ...
                        <t t-elif="uid and my == 'mine'">My questions</t>
                    ...
                    <div class="dropdown-menu position-absolute">
                        ...
                        <t t-if="uid">
                            ...
                            <a t-if="my != 'mine'" t-att-href="url_for('') + '?' + keep_query( 'search', 'sorting', 'filters', my='mine')" class="dropdown-item">My Questions</a>
...
<template id="display_post_question_block">
    ...
    <div class="d-flex align-items-center justify-content-between justify-content-sm-start small text-muted">
        ...
        <div>
            ...
            <a t-if="len(question.child_ids)&gt;0" class="font-weight-bold" t-attf-href="/forum/#{ slug(question.forum_id) }/question/#{ slug(question) }">
...
<template id="moderation_display_post_answer">
    <div class="clearfix">
        <div class="question-name">
            <a style="font-size: 15px;" t-attf-href="/forum/#{ slug(answer.forum_id) }/question/#{ answer.parent_id.id }/#answer-#{ answer.id }" t-esc="answer.parent_id.name"/>
            <b>[Answer]</b>
...
<template id="forum_all_all_entries">
    ...
    <t t-foreach="sorted_forums" t-as="forum">
        ...
        <div t-attf-class="mb-3 col-sm-6 #{not has_desc and 'col-md-3'}">
            <div t-attf-class="#{has_desc and 'row' or 'd-flex flex-column h-100'} #{no_description_exist and has_desc and 'py-4 bg-200'}">
                <div t-attf-class="#{has_desc and 'col-md-4 pr-md-0' or 'flex-lg-grow-1'}">
                    <a t-attf-href="/forum/#{slug(forum)}">
                        <div t-attf-class="oe_img_bg rounded shadow-sm py-4 px-5 o_wforum_forum_card_bg flex-shrink-0 h-100 o_not_editable {not has_desc and 'h-100'}"
                            t-attf-style="#{forum.image_256 and ('background-image: url(%s);' % website.image_url(forum, 'image_256'))} background-position: center;"/>
                    </a>
                </div>
                <div t-attf-class="mt-2 #{has_desc and 'col-md-8 mt-md-0'}">
                    <a t-attf-href="/forum/#{slug(forum)}" class="text-reset" t-att-title="forum.name">
                        <h3 t-attf-class="#{has_desc and 'h4' or 'h5 m-0'}" t-field="forum.name"/>
                    </a>
                    <p t-attf-class="m-0 #{has_desc and not no_description_exist and 'text-muted' or not has_desc and 'css_non_editable_mode_hidden'}"
...
<template id="website_forum.user_sidebar">
    <nav t-if="uid" class="o_wforum_nav nav nav-pills flex-column ml-4">
        ...
        <span t-if="my == 'mine'" class="nav-link rounded-pill mb-2 active font-weight-bold">
            <i class="fa fa-question-circle-o fa-fw"/> My Questions
    ...
    <t t-call="website_forum.header">
        <div class="row no-gutters">
            <div t-attf-class="d-flex justify-content-end flex-md-grow-1 #{(search or tag or my) and 'col-12 flex-column-reverse flex-md-row mb-3' or 'col-md-auto order-md-3'}">
                ...
                <a t-else="" role="button" type="button" class="btn btn-primary btn-block o_forum_ask_btn mb-3 mb-md-0" t-att-href="uid and '/forum/' + slug(forum) + '/ask' or '/web/login'">Ask a Question</a>
            </div>
        ...
        <div class="row mt-4">
            ...
            <!-- No questions or search/filters result -->
            <div t-if="question_count == 0" class="col">
                <div t-if="search or tag or (not no_filters)" class="alert alert-info">
                    ...
                    <t t-set="_my_str">
                        ...
                        <t t-if="my == 'mine'">in your questions</t>
                    </t>
                ...
                <t t-elif="not tag and not search and no_filters">
                    ...
                    <div t-elif="my == 'mine'" class="alert border">You have no questions in this forum (yet).</div>
                </t>

                <div t-elif="filters == 'unanswered'" class="alert alert-info">Amazing! There are not answered questions!</div>
...
<template id="new_question">
    <t t-call="website_forum.header">
        ...
        <form t-else="" t-attf-action="/forum/#{slug(forum)}/new" method="post" role="form" class="tag_text js_website_submit_form o_wforum_readable">
            <div class="form-group">
                <label for="content">Title</label>
                <input type="hidden" name="csrf_token" t-att-value="request.csrf_token()"/>
                <input type="text" name="post_name" required="required" pattern=".*\S.*" t-attf-value="#{post_name}"
                    class="form-control form-control-lg" placeholder="A clear, explicit and concise question title" title="Title must not be empty"/>
                ...
                <div class="form-text small text-muted">
                    ...
                    <div class="collapse" id="newQuestionExample">
                        ...
                        <div class="text-danger">
                            <i class="fa fa-times"/> Good morning to all! Please, can someone help solve solve my tax computation problem in Canada? Thanks!
                        </div>
                    </div>
                </div>
            </div>
...
<template id="edit_post">
    <t t-call="website_forum.header">
        ...
        <form t-attf-action="/forum/#{slug(forum)}/post/#{slug(post)}/save" method="post" role="form" class="tag_text js_website_submit_form o_wforum_readable">
            <input type="hidden" name="csrf_token" t-att-value="request.csrf_token()"/>
            <div t-if="not is_answer" class="form-group">
                ...
                <div class="form-text small text-muted">
                    ...
                    <div class="collapse" id="newQuestionExample">
                        <div class="my-2">Use a clear, explicit and concise question title</div>
    ...
    <t t-call="website_forum.header">
        ...
        <form t-attf-action="/forum/#{ slug(forum) }/#{offensive and 'post' or 'question'}/#{slug(question)}/#{offensive and 'mark_as_offensive' or 'close'}" method="post" role="form" class="mt32 mb64 js_website_submit_form">
            ...
            <div class="form-group">
                ...
                <a role="button" class="btn btn-light border" t-attf-href="/forum/#{ slug(forum) }/question/#{ slug(question) }">Discard</a>
            </div>
        </form>
    </t>
</template>
...
<template id="post_reply">
    <div class="css_editable_mode_hidden">
        <form class="collapse js_website_submit_form"
...
<template id="post_answer">
    ...
    <form t-attf-action="/forum/#{ slug(forum) }/#{slug(question)}/reply" method="post" class="js_website_submit_form" role="form">
        <input type="hidden" name="csrf_token" t-att-value="request.csrf_token()"/>
        <input type="hidden" name="karma" t-attf-value="#{user.karma}" id="karma"/>
        <textarea name="content" t-attf-id="content-#{str(question.id)}" class="form-control o_wysiwyg_loader" required="required" t-att-data-karma="forum.karma_editor"/>
    ...
    <t t-call="website_forum.header">
        ...
        <article t-attf-class="question o_wforum_post row no-gutters #{can_bump and 'oe_js_bump'}"
            ...
            <section class="col">
                ...
                <div t-field="question.content" class="o_wforum_post_content o_wforum_readable oe_no_empty"/>
                ...
                <div t-if="question.state == 'active' and question.active != False"
                    ...
                    <div t-if="not question.uid_has_answered and question.can_answer" class="btn-group btn-group-sm mr-2">
                        <a t-attf-class="btn btn-primary #{not question.can_answer and 'karma_required text-muted'}"
                            t-att-data-karma="question.forum_id.karma_answer"
                            href="#post_reply">
                ...
                <section t-if="question.child_ids" t-attf-class="#{question.website_message_ids and 'mt-5' or 'mt-4'}">
                    <h5>
                        <t t-esc="len(question.child_ids)"/>
                        <t t-if="len(question.child_ids) == 1">Answer</t>
                        <t t-else="">Answers</t>
                    </h5>
                ...
                <t t-if="question.state != 'close' and question.active != False and question.can_answer and not request.env.user.forum_waiting_posts_count">
                    <div id="post_reply" t-if="(not question.uid_has_answered or question.forum_id.mode == 'discussions')">
                        <t t-call="website_forum.post_answer"/>
                    </div>
                    <div t-elif="uid and request.env.user.forum_waiting_posts_count" class="alert alert-gamma text-center">
                    ...
                    <div t-elif="not uid" class="alert alert-gamma text-center">
        ...
        <div class="">
            <div class="row no-gutters">
                ...
                <div class="col">
                    ...
                    <div t-field="answer.content" class="mb-2 o_wforum_readable oe_no_empty"/>
...
<template id="post_comment">
    <div class="o_wforum_post_comments_container ml-2 ml-md-5">
        ...
        <div class="css_editable_mode_hidden o_wforum_readable">
            <form t-att-id="_collapse_uid" class="collapse p-1 oe_comment_grey js_website_submit_form"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header d-flex align-items-center pb-0">
                        ...
                        <button type="button" class="close align-self-start" data-dismiss="modal"><span>&amp;times;</span></button>
                    </div>
        ...
        <xpath expr="//div[@id='profile_extra_info_tabcontent']" position="inside">
            <t t-if="forum">
                <div role="tabpanel" class="o_wforum_profile_tab tab-pane" id="questions">
                    <div class="mb32">
                        <h5 class="border-bottom pb-1">Questions</h5>
                        <t t-if="questions">
                            <div class="mb4" t-foreach="questions" t-as="question">
                                <t t-call="website_forum.display_post"/>
                            </div>
                        </t>
                        <t t-else="">
                ...
                <div role="tabpanel" class="o_wforum_profile_tab tab-pane" id="answers">
                    <div class="mb32">
                        <h5 class="border-bottom pb-1">Answers</h5>
                        <t t-if="answers">
                ...
                <div role="tabpanel" class="o_wforum_profile_tab tab-pane" id="activity" t-if="uid == user.id">
                    <div class="mb32">
                        <h5 class="border-bottom pb-1">Activities</h5>
