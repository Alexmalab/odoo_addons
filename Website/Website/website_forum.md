    ...
    <data>
        <record id="default_faq" model="ir.ui.view">
            ...
            <field name="arch" type="xml">
                <div class="s_accordion mb-5" data-name="Accordion" data-vcss="000">
                    <div id="o_website_forum_faq" class="s_accordion_highlight accordion">
                        <div class="accordion-item position-relative z-1" data-name="Item">
                            <button type="button" id="o_website_forum_faq_btn_1" class="accordion-header accordion-button justify-content-between gap-2 bg-transparent h6-fs fw-bold text-decoration-none text-reset shadow-none transition-none" data-bs-target="#o_website_forum_faq_heading_1" aria-controls="o_website_forum_faq_heading_1" data-bs-toggle="collapse" aria-expanded="true">
                                <span class="flex-grow-1">What kind of questions can I ask here?</span>
                            </button>
                            <div id="o_website_forum_faq_heading_1" class="accordion-collapse collapse show" data-bs-parent="#o_website_forum_faq" role="region" aria-labelledby="o_website_forum_faq_btn_1">
                        ...
                        <div class="accordion-item position-relative z-1" data-name="Item">
                            <button type="button" id="o_website_forum_faq_btn_2" class="accordion-header accordion-button collapsed justify-content-between gap-2 bg-transparent h6-fs fw-bold text-decoration-none text-reset shadow-none transition-none" data-bs-target="#o_website_forum_faq_heading_2" aria-controls="o_website_forum_faq_heading_2" data-bs-toggle="collapse" aria-expanded="true">
                                <span class="flex-grow-1">What should I avoid in my questions?</span>
                            </button>
                            <div id="o_website_forum_faq_heading_2" class="accordion-collapse collapse" data-bs-parent="#o_website_forum_faq" role="region" aria-labelledby="o_website_forum_faq_btn_2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item position-relative z-1" data-name="Item">
                            <button type="button" id="o_website_forum_faq_btn_3" class="accordion-header accordion-button collapsed justify-content-between gap-2 bg-transparent h6-fs fw-bold text-decoration-none text-reset shadow-none transition-none" data-bs-target="#o_website_forum_faq_heading_3" aria-controls="o_website_forum_faq_heading_3" data-bs-toggle="collapse" aria-expanded="true">
                                <span class="flex-grow-1">What should I avoid in my answers?</span>
                            </button>
                            <div id="o_website_forum_faq_heading_3" class="accordion-collapse collapse" data-bs-parent="#o_website_forum_faq" role="region" aria-labelledby="o_website_forum_faq_btn_3">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item position-relative z-1" data-name="Item">
                            <button type="button" id="o_website_forum_faq_btn_4" class="accordion-header accordion-button collapsed justify-content-between gap-2 bg-transparent h6-fs fw-bold text-decoration-none text-reset shadow-none transition-none" data-bs-target="#o_website_forum_faq_heading_4" aria-controls="o_website_forum_faq_heading_4" data-bs-toggle="collapse" aria-expanded="true">
                                <span class="flex-grow-1">Why can other people edit my questions/answers?</span>
                            </button>
                            <div id="o_website_forum_faq_heading_4" class="accordion-collapse collapse" data-bs-parent="#o_website_forum_faq" role="region" aria-labelledby="o_website_forum_faq_btn_4">
                                <div class="accordion-body">
...
## File: data\website_forum_tour.xml

```xml
<?xml version="1.0" encoding="utf-8"?>
<odoo>
    <record id="question" model="web_tour.tour">
...
## File: static\src\xml\website_forum_tags_wrapper.xml
...
<odoo><data>
    ...
    <record id="forum_post_reason_view_list" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <list string="Reasons" editable="bottom">
                <field name="name"/>
