...
<p>Odoo v8 provides a web module and an e-commerce module: www.odoo.com/app/website
...
## File: static\src\xml\forum_wysiwyg.xml

```xml
<templates id="template" xml:space="preserve">
    <t t-name="website_forum.web_editor_toolbar" t-extend="web_editor.toolbar">
...
## File: views\forum_forum_add.xml
        ...
        <div>
             <div t-if="'karma' in fields" class='css_editable_mode_hidden'>
                ...
                <div t-if="options.get('badges')" style="display: inline-block">
                    ...
                    <span class="fa fa-trophy bg-silver ms-2" role="img" aria-label="Silver badge" title="Silver badge"/>
                    <t t-esc="object.silver_badge"/>
                    <span class="fa fa-trophy bg-bronze ms-2" role="img" aria-label="Bronze badge" title="Bronze badge"/>
...
<odoo><data>
    ...
    <template id="user_profile_content" inherit_id="website_profile.user_profile_content">
        ...
        <xpath expr="//ul[@id='profile_extra_info_tablist']" position="inside">
            <t t-if="forum">
                <li class="nav-item">
                    <a role="tab" aria-controls="questions" href="#questions" class="nav-link o_wprofile_navlink" data-bs-toggle="tab"><t t-esc="count_questions"/> Questions</a>
                </li>
                <li class="nav-item">
                    <a role="tab" aria-controls="answers" href="#answers" class="nav-link o_wprofile_navlink" data-bs-toggle="tab"><t t-esc="count_answers"/> Answers</a>
                </li>
            ...
            <t t-if="forum">
                <div role="tabpanel" class="o_wforum_profile_tab tab-pane" id="questions">
                    <div class="mb-4">
                        ...
                        <t t-else="">
                            <span class="fw-bold">No question posted yet.</span>
                        </t>
                    </div>
                    <t t-if="favourite">
                        <div class="mb-4">
                ...
                <div role="tabpanel" class="o_wforum_profile_tab tab-pane" id="answers">
                    <div class="mb-4">
                        ...
                        <t t-else="">
                            <span class="fw-bold">No answer posted yet.</span>
                        </t>
                    </div>
                </div>
    ...
    <template id="forum_filter_tag" name="Filtering Forum Tag">
        <t t-if="forum_filtered">
            <span class="align-items-baseline border d-inline-flex ps-2 rounded mb-1 ms-4">
                <i class="fa fa-filter me-2 text-muted"/>
    ...
    <template id="display_activities" name="Forum Profile Activities">
        <t t-if="activities">
            <div t-foreach="activities" t-as="activity" class="card mb-2">
                <div class="card-body">
                    <span t-esc="activity.subtype_id.name" class="badge text-bg-info me-2 mt-1"/>
...
<record id="action_forum_post" model="ir.actions.act_window">
    ...
    <field name="view_ids" eval="[(5, 0, 0),
        (0, 0, {'view_mode': 'tree', 'view_id': ref('view_forum_post_list')}),
