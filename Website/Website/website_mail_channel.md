...
## File: static\src\js\website_mail_channel.editor.js
...
## File: static\src\js\website_mail_channel.snippet.js
...
<template id="subscribe" inherit_id="website.snippets" name="Snippet Subscribe">
    ...
    <xpath expr="//div[@id='snippet_options']" position="inside">
        <div data-js='subscribe'
            ...
            <we-button data-select_mailing_list="" data-no-preview="true">Change Discussion List</we-button>
        </div>
    </xpath>
