...
<odoo><data noupdate="0">
    ...
    <record id="badge_data_register_challenge" model="gamification.challenge">
        ...
        <field name="category">slides</field>
        <field name="period">once</field>
        <field name="visibility_mode">personal</field>
        <field name="report_message_frequency">never</field>
        <field name="reward_id" eval="ref('badge_data_register')"/>
    ...
    <record id="badge_data_register_challenge_line_0" model="gamification.challenge.line">
        <field name="definition_id" eval="ref('badge_data_register_goal')"/>
        <field name="challenge_id" eval="ref('badge_data_register_challenge')"/>
    ...
    <record id="badge_data_profile_challenge" model="gamification.challenge">
        ...
        <field name="visibility_mode">personal</field>
        <field name="report_message_frequency">never</field>
        <field name="reward_id" eval="ref('badge_data_profile')"/>
        <field name="reward_realtime">True</field>
        <field name="user_domain">[('karma', '>', 0)]</field>
        <field name="state">inprogress</field>
    </record>
    <record id="badge_data_profile_challenge_line_0" model="gamification.challenge.line">
        <field name="definition_id" eval="ref('badge_data_profile_goal')"/>
        <field name="challenge_id" eval="ref('badge_data_profile_challenge')"/>
        <field name="target_goal">1</field>
    </record>
    ...
    <record id="badge_data_course_challenge" model="gamification.challenge">
        ...
        <field name="visibility_mode">personal</field>
        <field name="report_message_frequency">never</field>
        <field name="reward_id" eval="ref('badge_data_course')"/>
        <field name="reward_realtime">True</field>
        <field name="user_domain">[('karma', '>', 0)]</field>
        <field name="state">inprogress</field>
    </record>
    <record id="badge_data_course_challenge_line_0" model="gamification.challenge.line">
        <field name="definition_id" eval="ref('badge_data_course_goal')"/>
        <field name="challenge_id" eval="ref('badge_data_course_challenge')"/>
        <field name="target_goal">1</field>
    </record>
    ...
    <record id="badge_data_certification_challenge" model="gamification.challenge">
        ...
        <field name="visibility_mode">personal</field>
        <field name="report_message_frequency">never</field>
        <field name="reward_id" eval="ref('badge_data_certification')"/>
        <field name="reward_realtime">True</field>
        <field name="user_domain">[('karma', '>', 0)]</field>
        <field name="state">inprogress</field>
    </record>
    <record id="badge_data_certification_challenge_line_0" model="gamification.challenge.line">
        <field name="definition_id" eval="ref('badge_data_certification_goal')"/>
        <field name="challenge_id" eval="ref('badge_data_certification_challenge')"/>
        <field name="target_goal">1</field>
    </record>

    <!-- Community hero: read 2000 XP -->
    ...
    <record id="badge_data_karma_challenge" model="gamification.challenge">
        <field name="name">Read 2000 XP</field>
        <field name="category">slides</field>
        <field name="period">once</field>
        <field name="visibility_mode">personal</field>
        <field name="report_message_frequency">never</field>
        <field name="reward_id" eval="ref('badge_data_karma')"/>
        <field name="reward_realtime">True</field>
        <field name="user_domain">[('karma', '>', 0)]</field>
        <field name="state">inprogress</field>
    </record>
    <record id="badge_data_karma_challenge_line_0" model="gamification.challenge.line">
        <field name="definition_id" eval="ref('badge_data_karma_goal')"/>
        <field name="challenge_id" eval="ref('badge_data_karma_challenge')"/>
        <field name="target_goal">1</field>
    </record>
</data></odoo>
...
<odoo><data noupdate="1">
    ...
    <record id="slide_slide_demo_0_1" model="slide.slide">
        ...
        <field name="description">Interesting informations about home gardening. Keep it close !</field>
    </record>
    ...
    <div class="container">
        <div class="row s_nb_column_fixed">
            <div class="col-lg-12 s_title">
                <h1 class="s_title_thin o_default_snippet_text" style="font-size: 62px; text-align: center;">Catchy Headline</h1>
            </div>
            <div class="col-lg-12 s_text pt16 pb16">
            ...
            <div class="col-lg-12 s_btn text-center pt16 pb16">
...
<odoo><data noupdate="1">
    ...
    <!-- First of all: remove admin of all memberships to avoid noisy demo data -->
    <function model="slide.channel"
        name="_remove_membership"
        eval="[
            [ref('website_slides.slide_channel_demo_0_gard_0'),
             ref('website_slides.slide_channel_demo_1_gard1'),
             ref('website_slides.slide_channel_demo_2_gard2'),
             ref('website_slides.slide_channel_demo_3_furn0'),
             ref('website_slides.slide_channel_demo_4_furn1'),
             ref('website_slides.slide_channel_demo_5_furn2'),
             ref('website_slides.slide_channel_demo_6_furn3')],
...
class Challenge(models.Model):
    ...
    category = fields.Selection(selection_add=[('slides', 'Website / Slides')])
...
access_slide_slide_publisher,slide.slide.publisher,model_slide_slide,website.group_website_publisher,1,1,1,1
access_slide_slide_partner_all,slide.slide.partner.all,model_slide_slide_partner,,0,0,0,0
access_slide_slide_partner_system,slide.slide.partner.system,model_slide_slide_partner,website.group_website_publisher,1,1,1,1
access_slide_question_all,slide.question.all,model_slide_question,,1,0,0,0
access_slide_question_publisher,slide.question.publisher,model_slide_question,website.group_website_publisher,1,1,1,1
access_slide_answer_all,slide.answer.all,model_slide_answer,,0,0,0,0
access_slide_answer_publisher,slide.answer.publisher,model_slide_answer,website.group_website_publisher,1,1,1,1
access_slide_tag_all,slide.tag.all,model_slide_tag,,1,0,0,0
access_slide_tag_publisher,slide.tag.publisher,model_slide_tag,website.group_website_publisher,1,1,1,1
access_slide_channel_tag_all,slide.channel.tag.all,model_slide_channel_tag,,1,0,0,0
access_slide_channel_tag_user,slide.channel.tag.user,model_slide_channel_tag,website.group_website_publisher,1,1,1,1
access_slide_channel_tag_group_all,slide.channel.tag.group.all,model_slide_channel_tag_group,,1,0,0,0
access_slide_channel_tag_group_user,slide.channel.tag.group.user,model_slide_channel_tag_group,website.group_website_publisher,1,1,1,1
...
## File: static\src\xml\channel_management.xml
        ...
        <form class="clearfix">
            <div class="form-group row">
                <div class="controls mt8 ml-3">
                    ...
                    <label for="subscribed" class="col-form-label font-weight-normal">Subscribe to get notified when a new content is added.</label>
                </div>
            </div>
        </form>
    </t>
                            ...
                            <div class="oe_kanban_global_click o_kanban_record_has_image_fill">
                                ...
                                <div class="oe_kanban_details d-flex flex-column">
                                    ...
                                    <div class="o_kanban_record_bottom mt-auto d-flex justify-content-between align-items-end">
                                        ...
                                        <img t-att-src="kanban_image('res.users', 'image_128', record.user_id.raw_value)" t-att-title="record.user_id.value" t-att-alt="record.user_id.value" class="oe_kanban_avatar o_image_24_cover"/>
                                    </div>
                                </div>
                            </div>
                        </t>
            ...
            <div class="o_wslides_slide_fs_header d-flex flex-shrink-0 text-white">
                ...
                <div class="d-flex ml-auto">
                    ...
                    <a class="d-flex align-items-center px-3" t-attf-href="/slides/#{slug(slide.channel_id)}">
                        <i class="fa fa-home d-md-none"/><span class="d-none d-md-inline-block ml-1">Back to course</span>
                    </a>
                </div>
            </div>
        ...
        <xpath expr="//div[@id='profile_about_badge']" position="before">
            <t t-if="channel">
                <div class="mb32">
                    ...
                    <p t-else="" class="text-muted">No completed course yet</p>
                </div>
                <div class="mb32">
                    ...
                    <p t-else="" class="text-muted">No followed course yet</p>
                </div>
            </t>
        </xpath>
    </template>
