...
<templates>
    ...
    <t t-extend="website.slides.fullscreen.title">
        <t t-jquery=".o_wslides_fs_slide_title_span" t-operation="before">
            <i t-if="widget.get('slide').category === 'certification'" class="fa fa-trophy me-2 text"></i>
        </t>
    </t>
</templates>
        ...
        <field name="arch" type="xml">
            <xpath expr="//field[@name='completed']" position="after">
                <field name="survey_scoring_success" readonly="1"
                    attrs="{'invisible': [('slide_category', '!=', 'certification')]}"/>
            </xpath>
    ...
    <template id="user_profile_content" inherit_id="website_profile.user_profile_content">
     ...
     <template id="display_certificate">
        ...
        <div class="text-end d-inline-block pull-right">
            <a href="/slides/all?slide_category=certification" class="btn btn-link btn-sm"><i class="fa fa-arrow-right me-1"/>All Certifications</a>
        </div>
    </template>
