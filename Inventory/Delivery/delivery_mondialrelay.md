...
## File: static\src\js\mondialrelay.js
    ...
    <record id="view_delivery_carrier_form_provider_mondialrelay" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <field name="product_id" position="after">
                ...
                <field name="mondialrelay_brand" attrs="{'required': [('is_mondialrelay', '=', True)], 'invisible': [('is_mondialrelay', '!=', True)]}" />
            </field>
        </field>
    </record>
    ...
    <record id="choose_delivery_carrier_view_form" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <form position="inside">
                <field name="is_mondialrelay" invisible="1"/>
                <div class="o_zone_widget" attrs="{'invisible': [('is_mondialrelay', '=', False)]}"/>
