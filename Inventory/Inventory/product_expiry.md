...
## File: report\report_package_barcode.xml
...
<odoo>
    <record id="view_stock_quant_tree" model="ir.ui.view">
        <field name="name">stock.quant.tree.inherit.expiry_date</field>
    ...
    <record id="view_stock_quant_tree_inventory_editable" model="ir.ui.view">
        <field name="name">stock.quant.inventory.tree.editable.inherit.expiry_date</field>
        <field name="model">stock.quant</field>
