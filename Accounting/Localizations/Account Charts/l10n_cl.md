...
<odoo>
    ...
    <record id="account_410190" model="account.account.template">
        ...
        <field name="account_type">off_balance</field>
        <field name="reconcile" eval="False"/>
        <field name="chart_template_id" ref="cl_chart_template"/>
    </record>
    ...
    <record id="cl_chart_template" model="account.chart.template">
        ...
        <field name="property_tax_payable_account_id" ref="account_210760"/>
        <field name="property_tax_receivable_account_id" ref="account_210760"/>
    </record>
