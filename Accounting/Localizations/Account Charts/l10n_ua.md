...
## File: data\template\account.account-ua_psbo.csv
...
## File: data\template\account.group-ua_psbo.csv
...
```csv
"id","sequence","name","description","invoice_label","amount","type_tax_use","tax_group_id","active","repartition_line_ids/repartition_type","repartition_line_ids/document_type","repartition_line_ids/account_id","name@uk_UA","invoice_label@uk_UA"
