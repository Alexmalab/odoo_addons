...
<odoo>
    ...
    <record id="view_invoice_tree_inherit_l10n_my_myinvois" model="ir.ui.view">
        <field name="name">account.move.tree.inherit.l10n_my_myinvois</field>
        <field name="model">account.move</field>
                    ...
                    <group string="E-Invoicing" colspan="2">
                        ...
                        <div class="d-flex gap-2 w-50">
                            ...
                            <span class="d-flex gap-2 w-50">
                                <field name="l10n_my_identification_number" placeholder="202001234567"/>
                            </span>
                        </div>
...
<odoo>
    <data>
        <record model="ir.ui.view" id="account_move_send_inherit_l10n_my_edi">
            <field name="name">account.move.send.form.inherit.l10n_my_edi</field>
            ...
            <field name="arch" type="xml">
                ...
                <xpath expr="//div[@name='option_send_mail']" position='after'>
                    <div name="option_l10n_my_edi_send" invisible="not l10n_my_edi_enable">
                        <field name="l10n_my_edi_send_checkbox"/>
                        <b>
                            <label for="l10n_my_edi_send_checkbox"/>
                        </b>
                    </div>
                </xpath>
            </field>
