    ...
    <record id="view_partner_property_form_inherit_ubl_tr" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <xpath expr="//field[@name='ubl_cii_format']" position="after">
                <label for="l10n_tr_nilvera_customer_status" invisible="ubl_cii_format != 'ubl_tr'"/>
                <div class="row" invisible="ubl_cii_format != 'ubl_tr'">
                        <div class="col-4">
                ...
                <field name="l10n_tr_nilvera_customer_alias_id" invisible="ubl_cii_format != 'ubl_tr' or l10n_tr_nilvera_customer_status != 'einvoice'"/>
            </xpath>
        </field>
    </record>
</odoo>
