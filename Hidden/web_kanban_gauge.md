...
## File: static\src\js\kanban_gauge.js
...
## File: views\web_kanban_gauge_templates.xml
...
<odoo>
        ...
        <template id="qunit_suite" name="gauge_tests" inherit_id="web.qunit_suite_tests">
            <xpath expr="." position="inside">
                <script type="text/javascript" src="/web_kanban_gauge/static/tests/gauge_tests.js"></script>
            </xpath>
        </template>
</odoo>
