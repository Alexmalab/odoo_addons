# Odoo Module: spreadsheet_dashboard_sale_timesheet
...
## File: data\files\timesheet_dashboard.json
  ...
  "sheets": [
    {
      ...
      "cells": {
        ...
        "F34": { "content": "=PIVOT.HEADER(2,\"#task_id\",10)" },
        "F36": {
        ...
        "G34": { "content": "=PIVOT.VALUE(2,\"unit_amount\",\"#task_id\",10)" },
        ...
        "H34": {
          "content": "=PIVOT.VALUE(2,\"billable_time\",\"#task_id\",10)"
        },
...
## File: data\files\timesheet_sample_dashboard.json
