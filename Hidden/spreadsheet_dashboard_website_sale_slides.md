# Odoo Module: spreadsheet_dashboard_website_sale_slides
...
## File: data\files\elearning_dashboard.json
...
```json
{
  ...
  "sheets": [
      ...
      "figures": [
        {
          ...
          "data": {
            ...
            "searchParams": {
              ...
              "domain": [["product_id.channel_ids", "!=", false]],
              "groupBy": ["date:month"],
              "orderBy": []
            },
            "type": "odoo_line",
            ...
            "fillArea": true,
            "fieldMatching": {
              "46b74887-ff98-4c97-9629-4a5a14084321": {
                "chain": "date",
                "type": "datetime",
                "offset": 0
              }
    ...
    },
    {
      ...
      "rowNumber": 96,
      "rows": {},
      "cols": { "0": { "size": 114 }, "1": { "size": 89 } },
      "merges": [],
      "cells": {
        "A2": { "content": "=_t(\"Courses\")" },
        "A3": { "content": "=_t(\"Content\")" },
        "A4": { "content": "=_t(\"Attendees\")" },
        "A5": { "content": "=_t(\"Rating\")" },
        "A6": { "content": "=_t(\"Revenue\")" },
        "B1": { "content": "=_t(\"Current\")" },
        "B2": { "content": "=PIVOT.VALUE(4,\"__count\")" },
        "B3": { "content": "=PIVOT.VALUE(5,\"__count\")" },
        "B4": { "content": "=PIVOT.VALUE(6,\"__count\")" },
        "B5": { "content": "=PIVOT.VALUE(9,\"rating\")" },
        "B6": { "content": "=PIVOT.VALUE(10,\"price_total\")" },
        "C1": { "content": "=_t(\"Previous\")" },
        "C2": { "content": "/" },
        "C3": { "content": "/" },
        "C4": { "content": "=PIVOT.VALUE(7,\"__count\")" },
        "C6": { "content": "=PIVOT.VALUE(11,\"price_total\")" },
        "D1": { "content": "=_t(\"Current\")" },
        "D2": { "content": "=FORMAT.LARGE.NUMBER(B2)" },
        "D3": { "content": "=FORMAT.LARGE.NUMBER(B3)" },
        "D4": { "content": "=FORMAT.LARGE.NUMBER(B4)" },
        "D5": { "content": "=CONCATENATE(B5,\"/5\")" },
  ...
  "pivots": {
    ...
    "5": {
      ...
      "context": {},
      "domain": ["&", ["is_category", "=", false], ["is_published", "=", true]],
      "id": "5",
      "measures": [{ "id": "__count", "fieldName": "__count" }],
      "model": "slide.slide",
      "name": "content",
    ...
    "9": {
      ...
      "id": "9",
      "measures": [{ "id": "rating", "fieldName": "rating" }],
      "model": "rating.rating",
      "name": "rating",
      "sortedColumn": null,
      "formulaId": "9",
    ...
    "10": {
      ...
      "id": "10",
      "measures": [{ "id": "price_total", "fieldName": "price_total" }],
      "model": "sale.report",
...
## File: data\files\elearning_sample_dashboard.json
