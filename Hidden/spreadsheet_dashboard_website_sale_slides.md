...
<odoo>
    ...
    <record id="spreadsheet_dashboard_elearning" model="spreadsheet.dashboard">
        ...
        <field name="data" type="base64" file="spreadsheet_dashboard_website_sale_slides/data/files/elearning_dashboard.json"/>
...
```json
{
    ...
    "sheets": [
        ...
        },
        {
            ...
            "cells": {
                ...
                "B5": {
                    "format": 1,
                    "content": "=ODOO.PIVOT(9,\"rating\")"
                },
                "B6": {
                    "content": "=ODOO.PIVOT(10,\"price_total\")"
                },
                "C1": {
                    "style": 2,
                    "content": "=_t(\"Previous\")"
                ...
                "C4": {
                    "content": "=ODOO.PIVOT(7,\"__count\")"
                },
                "C6": {
                    "content": "=ODOO.PIVOT(11,\"price_total\")"
                },
                "D1": {
                    "style": 2,
                    "content": "=_t(\"Current\")"
    ...
    "revisionId": "aebd5982-19e1-4e68-8d75-6e1ef9493c95",
    ...
    "globalFilters": [
        {
            ...
            "listFields": {},
            "graphFields": {
                "e4d80a72-4568-4b7b-9f10-439064db939e": {
                    "field": "date",
                    "type": "datetime",
                    "offset": 0
                },
                "2f9b379a-0281-4399-8bc8-8847019c8ac7": {
                    "field": "create_date",
                    "type": "datetime",
                    "offset": 0
                },
                "122a4eb9-dc29-498c-bbbd-274252546078": {
                    "field": "create_date",
                    "type": "datetime",
                    "offset": 0
                }
