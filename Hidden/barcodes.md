...
<odoo>
       ...
       <template id="assets_backend" name="barcodes assets" inherit_id="web.assets_backend">
        ...
        <template id="qunit_suite" name="barcode_tests" inherit_id="web.qunit_suite_tests">
            <xpath expr="." position="inside">
                <script type="text/javascript" src="/barcodes/static/tests/barcode_tests.js"/>
            </xpath>
        </template>

        <template id="qunit_mobile_suite" name="barcode_mobile_tests" inherit_id="web.qunit_mobile_suite_tests">
            <xpath expr="." position="inside">
