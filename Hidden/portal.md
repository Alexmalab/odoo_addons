...
<templates id="template" xml:space="preserve">
    ...
    <t t-name="portal.chatter_internal_toggle">
        ...
        <div t-else="" t-attf-class="float-end o_portal_chatter_js_is_internal #{message.is_internal and 'o_portal_message_internal_on' or 'o_portal_message_internal_off'}"
