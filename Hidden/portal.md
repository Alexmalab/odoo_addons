...
## File: controllers\message_reaction.py
...
## File: static\src\chatter\boot\boot_service.js
...
## File: static\src\chatter\core\chatter_patch.js
...
## File: static\src\chatter\core\composer_patch.js
...
## File: static\src\chatter\core\composer_patch.xml
...
## File: static\src\chatter\core\message_patch.xml
...
## File: static\src\chatter\core\picker_patch.js
...
## File: static\src\chatter\core\portal_chatter.xml
...
## File: static\src\chatter\core\thread_model_patch.js
...
## File: static\src\chatter\frontend\attachment_upload_service_patch.js
...
## File: static\src\chatter\frontend\chatter_patch.js
...
## File: static\src\chatter\frontend\composer_model_patch.js
...
## File: static\src\chatter\frontend\composer_patch.js
...
## File: static\src\chatter\frontend\message_patch.js
...
## File: static\src\chatter\frontend\portal_chatter.js
...
## File: static\src\chatter\frontend\portal_chatter_service.js
...
## File: static\src\chatter\frontend\store_service_patch.js
...
## File: static\src\chatter\frontend\thread_model_patch.js
...
<odoo>
               ...
               <t t-set="active_lang" t-value="frontend_languages[lang]"/>
                <button t-attf-class="border-0 dropdown-toggle #{_btn_class or 'btn btn-sm btn-outline-secondary'}" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    <span t-if="not no_text"
                            t-attf-class="#{_txt_class}"
                            t-esc="active_lang.name.split('/').pop()"/>
    ...
    <template id="portal_docs_entry_layout" inherit_id="portal.portal_docs_entry" active="True" customize_show="True" name="Use Pictograms">
        <xpath expr="//div[hasclass('o_portal_icon')]" position="attributes">
            <attribute name="class" remove="d-none" add="d-block align-self-start" separator=" "/>
        </xpath>
    </template>
    ...
    <template id="portal_record_sidebar" name="My Portal Record Sidebar">
        <div t-attf-class="d-flex #{classes}">
            ...
            <div class="collapse navbar-collapse flex-wrap-reverse justify-content-end gap-3" id="o_portal_navbar_content">
                <div class="nav flex-column flex-sm-row gap-2 ms-auto p-0 mb-3 mb-lg-0 mt-1 mt-lg-0">
                    ...
                    <div t-if="searchbar_filters" class="ms-lg-2">
                        ...
                        <div class="btn-group">
                            <button id="portal_searchbar_filters" data-bs-toggle="dropdown" class="btn btn-light dropdown-toggle">
                    ...
                    <div t-if="searchbar_groupby" class="ms-lg-2">
                        ...
                        <div class="btn-group">
                            <button id="portal_searchbar_groupby" data-bs-toggle="dropdown" class="btn btn-light dropdown-toggle">
                ...
                <form t-if="searchbar_inputs" class="o_portal_search_panel col-md-5 col-xl-4 ms-lg-2">
                    <div class="input-group w-100">
                        <button type="button" class="btn btn-light border-end dropdown-toggle" data-bs-toggle="dropdown"/>
    ...
    <template id="portal_my_contact">
        <div t-attf-class="o_portal_contact_details d-flex flex-column gap-2 #{_spacingClass}">
    ...
    <template id="portal_my_security">
        <t t-call="portal.portal_layout"><div class="o_portal_security_body w-md-75 w-lg-50 pb-5">
            ...
            <h4>Revoke All Sessions</h4>
                <t t-set="path"/>
                    <button type="button" class="btn btn-light" id="portal_revoke_all_sessions_popup">
