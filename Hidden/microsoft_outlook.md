    ...
    <record id="ir_mail_server_view_form" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            ...
            <field name="smtp_authentication_info" position="after">
                <a href="https://www.odoo.com/documentation/17.0/applications/general/email_communication/email_servers.html?highlight=outgoing email server#use-a-default-from-email-address"
