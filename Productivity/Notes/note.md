...
## File: static\src\components\activity_menu_view\activity_menu_view.js
...
## File: static\src\models\activity_menu_view.js
...
<odoo>
    ...
    <record id="view_note_note_form" model="ir.ui.view">
        ...
        <field name="model">note.note</field>
        <field name="arch" type="xml">
            <form string="Note" class="o_note_form_view">
                <header>
