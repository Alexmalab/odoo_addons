...
<template id="session_topbar" name="Tracks Tools">
    <div>
        <div class="o_wesession_topbar_filters o_wevent_index_topbar_filters d-print-none d-flex flex-wrap align-items-center justify-content-end gap-2 w-100 mb-3">
            <h3 class="mt-3 mb-3 me-auto pe-sm-4">Talks</h3>
...
<template id="session_topbar_tag"
    ...
    <xpath expr="//div[hasclass('o_wevent_search')]" position="before">
        <t t-foreach="tag_categories" t-as="tag_category">
            <div t-if="tag_category.tag_ids and any(tag.color for tag in tag_category.tag_ids)" class="dropdown d-none d-lg-block me-2 my-1">
                <a href="#" role="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown">
                    <t t-out="tag_category.name"/>
                </a>
                <div class="dropdown-menu">
...
<template id="tracks_display_list" name="Tracks: List Display">
    <div t-if="tracks">
        <h4>Book your talks</h4>
        <p class="mb-3">Plan your experience by adding your favorites talks to your wishlist</p>
    </div>
...
<template id="track_tag_badge_info" name="Track: Tag Badge Info">
    <span t-if="search_tags"
        ...
        t-out="tag.name"/>
    <span t-else=""
        t-att-class="'badge rounded-pill o_tag_color_%s' % (tag.color)"
        t-out="tag.name"/>
</template>
        ...
        <div class="o_wesession_track_main_description overflow-auto">
            ...
            <t t-elif="env.user.has_group('event.group_event_user')">
                ...
                <div class="alert alert-info mt-3 o_wesession_track_main_empty_descr_warning">
                    ...
                    <a class="alert-link" t-attf-href="?{{ keep_query('*', enable_editor=1) }}">
    ...
    <t t-call="website_event.layout">
        ...
        <div class="container">
            <section class="row mb-3">
                <div class="col-lg-8 col-xl-9 pe-xxl-5">
                        ...
                        <section id="forms" t-if="event.website_track_proposal">
                            <form class="js_website_submit_form o_website_event_track_proposal_form row mt-3" t-att-data-event-id="event.id" enctype="multipart/form-data">
                                ...
                                <div id="speaker_profile" class="col-12">
                                    <h4 class="mt-3">Speaker Profile</h4>
                                    <div class="form-text text-muted mb16">
                                ...
                                <div class="o_form_buttons col-12 d-flex align-items-center pb-5">
                ...
                <aside class="col-lg-4 col-xl-3 mt-3 mt-lg-0 pt-3">
...
<template id="event_track_proposal_contact_details">
    <div id="event_track_proposal_additional_contact_section" class="col-12">
        ...
        <div class="o_wetrack_contact_information d-none">
            <h4><b class="fw-normal">Contact Information</b></h4>
            <div class="form-text text-muted mb16">
