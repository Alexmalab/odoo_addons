...
<div class="text-center font-weight-bold py-3">Important ticket information</div>
<ul>
...
class MailTemplate(models.Model):
    ...
    def unlink(self):
        res = super(MailTemplate, self).unlink()
...
## File: static\src\js\field_icon_selection.js
...
## File: static\src\xml\field_icon_selection.xml
                    ...
                    <sheet string="Registration">
                        ...
                        <group>
                            ...
                            <group string="Event Information" name="event">
                                <field class="text-break" name="event_id" attrs="{'readonly': [('state', '!=', 'draft')]}" options="{'no_create': True}"/>
