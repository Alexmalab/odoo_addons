...
access_event_meeting_room_public,event.meeting.room,model_event_meeting_room,base.group_public,1,0,0,0
access_event_meeting_room_portal,event.meeting.room,model_event_meeting_room,base.group_portal,1,0,0,0
access_event_meeting_room_employee,event.meeting.room,model_event_meeting_room,base.group_user,1,0,0,0
        ...
        <div class="d-flex flex-column justify-content-start align-items-start">
            ...
            <div t-if="not meeting_rooms" class="m-auto text-center text-muted">
                ...
                <div groups="event.group_event_user">
                    <a target="_blank" t-att-href="'/odoo/%s/action-website_event_meet.action_meeting_room_from_event' % event.id">
