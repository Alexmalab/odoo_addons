            ...
            <div class="row mt-2">
                <t t-if="! widget.sponsorData.event_is_ongoing">
                    <div class="col-12 alert alert-warning text-center" role="alert"
                        ...
                        Event <span t-out="widget.sponsorData.event_name" class="fw-bold"/> is over.
                    ...
                    <div class="col-12 alert alert-warning text-center" role="alert"
                        t-else="">
                        <span t-out="widget.sponsorData.name" class="fw-bold"/> is not available right now.<br />
                        Event <span t-out="widget.sponsorData.event_name" class="fw-bold"/>
                    ...
                    <div class="d-flex align-items-top mb-3">
                        <div class="d-flex flex-column">
                            ...
                            <span t-if="widget.sponsorData.url">
                                <i class="fa fa-home me-2"/><a t-att-href="widget.sponsorData.url"><span t-out="widget.sponsorData.url"/></a>
                            </span>
                            <span t-if="widget.sponsorData.email">
                                <i class="fa fa-envelope me-2"/><a t-att-mailto="widget.sponsorData.email"><span t-out="widget.sponsorData.email"/></a>
                            </span>
                            <span t-if="widget.sponsorData.phone">
                                <i class="fa fa-phone me-2"/><span t-out="widget.sponsorData.phone"/>
                            </span>
                        </div>
    ...
    <nav class="navbar navbar-light border-top shadow-sm d-print-none">
        <div class="container">
            <div class="d-flex flex-column flex-sm-row justify-content-between w-100">
                ...
                <div class="o_wevent_event_search_box d-flex align-items-center flex-wrap ps-sm-3 pe-0">
...
<template id="exhibitor_card" name="Exhibitor Card">
    <article class="h-100 card border-0 shadow-sm o_wesponsor_card"
        ...
        <div class="h-100 row g-0" t-att-data-publish="sponsor.website_published and 'on' or 'off'">
            ...
            <header t-att-class="'overflow-hidden col-12 %s' % ('bg-secondary' if not sponsor_image_url else '')">
                <div class="d-block h-100 w-100">
                    <div t-if="sponsor_image_url" class="card-img-top position-static o_wesponsor_bg_image"
                        ...
                        <img class="position-absolute me-2 mt-2"
...
<template id="exhibitors_search_tag" name="Exhibitors: term">
    <span t-att-data-field="field" t-att-data-value="value"
        class="o_search_tag align-items-baseline border d-inline-flex ps-2 mt-3 rounded ml16 mb-2 bg-white">
...
<template id="exhibitor_main" name="Exhibitor: Main Content">
    <div t-att-class="'col-12 o_wesponsor_exhibitor_main border mt-3 p-0 %s' % ('col-md-9 col-lg-10' if option_widescreen else 'col-md-8 col-lg-9')">
            ...
            <div class="o_wevent_sponsor pt-3 d-flex flex-row justify-content-between position-relative">
                <div class="d-flex flex-column">
                    ...
                    <div t-if="sponsor.url" class="d-flex text-break align-items-baseline">
                        <i class="fa fa-home me-2"/><a t-att-href="sponsor.url"><span t-field="sponsor.url"/></a>
                    </div>
                    <div t-elif="sponsor.partner_id.website" class="d-flex text-break align-items-baseline">
                        <i class="fa fa-home me-2"/><a t-att-href="sponsor.partner_id.website"><span t-field="sponsor.partner_id.website"/></a>
                    </div>
                ...
                <a t-if="sponsor.partner_id.country_id"
                    ...
                    t-attf-class="text-end d-none d-md-block #{'me-5' if sponsor.sponsor_type_id.display_ribbon_style and sponsor.sponsor_type_id.display_ribbon_style != 'no_ribbon' else ''}">
                    <img class="img"
                        style="max-height: 36px;"
                        t-att-src="sponsor.partner_id.country_id.image_url"
                        t-att-alt="sponsor.partner_id.country_id.name"/>
...
<template id="exhibitor_aside" name="Exhibitor: Aside">
    <div t-att-class="'col-12 mt-3 ps-0 pe-0 border o_wevent_online_page_aside o_wesponsor_exhibitor_aside %s' % ('col-md-3 col-lg-2' if option_widescreen else 'col-md-4 col-lg-3')">
        <div class="o_wevent_online_page_aside_content">
            ...
            <ul id="collapse_exhibitor_aside" class="list-unstyled collapse d-lg-block mb-0">
                <li t-foreach="sponsors_other" t-as="sponsor_other">
                    <a class="row g-0 px-2 pt-2 pb-1 text-decoration-none"
                        ...
                        <div class="col-3 d-flex flex-column align-items-center">
                            ...
                            class="me-2 mb-1 o_wesponsor_aside_logo"
                            ...
                            <span t-if="sponsor_other.sponsor_type_id.display_ribbon_style not in [False, 'no_ribbon']"
                                t-att-class="'badge text-bg-light me-2 ribbon_%s' % sponsor_other.sponsor_type_id.display_ribbon_style"
                                t-out="sponsor_other.sponsor_type_id.name"/>
                            <span t-else="" class="badge text-bg-light me-2"
                                t-out="sponsor_other.sponsor_type_id.name"/>
                        </div>
                    ...
                    <t t-foreach="event.sponsor_ids.sorted(
                        ...
                        <t t-set="popover_content">
                            ...
                            <div t-if="sponsor.url" class="d-flex align-items-baseline">
                                <i class="fa fa-home me-2"/><a t-att-href="sponsor.url" t-field="sponsor.url" class="text-truncate"/>
                            </div>
                        </t>
...
<template id="snippet_options" inherit_id="website.snippet_options" name="Event exhibitor snippet options">
    <xpath expr="." position="inside">
        <div data-selector="main:has(nav .o_wevent_event_tags_form)" data-page-options="true" groups="website.group_website_designer" data-no-check="true" string="Event Page">
