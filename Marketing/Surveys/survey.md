                            ...
                            <group>
                                ...
                                <group string="Live Sessions">
                                    ...
                                    <div>
                                        ...
                                        <span invisible="not is_time_limited"> seconds</span>
                                    </div>
                                </group>
                            </group>
                        </page>
            ...
            <form string="Survey" class="o_survey_form">
                ...
                <header>
                    ...
                    <button name="action_start_session" string="Create Live Session" type="object" class="d-none d-sm-block"
                        invisible="session_state or not active or certification or survey_type in ('survey', 'assessment')" />
                    ...
                    <button name="action_print_survey" string="Print" type="object" invisible="not active"/>
                        ...
                        <page string="Options" name="options">
                            <group name="options">
                                ...
                                <group string="Live Session"
                                       invisible="survey_type in ('survey', 'assessment')">
    ...
    <record id="survey_survey_view_search" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <search string="Survey">
                ...
                <field string="Responsible" name="user_id"/>
                ...
                <sheet>
                    ...
                    <notebook>
                        <page string="Answers" name="page_answers">
                            <field name="user_input_line_ids" mode="tree" readonly="True" no_label="1">
