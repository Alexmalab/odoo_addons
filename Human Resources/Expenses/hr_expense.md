...
<odoo>
    <data noupdate="1">
        ...
        <record id="mt_expense_approved" model="mail.message.subtype">
            ...
            <field name="description">Expense report approved, entry created for accountant</field>
        </record>
    ...
    <data noupdate="1">
        ...
        <template id="hr_expense_template_register">
            ...
            <p t-if="expense.employee_id.user_id">
                <br/>
                <a t-att-href="'/odoo/hr.expense/%s' % (expense.id)" style="background-color: #9E588B; margin-top: 10px; padding: 10px; text-decoration: none; color: #fff; border-radius: 5px; font-size: 16px;">View Expense</a>
            </p>
        </template>
...
## File: static\src\js\web\activity_menu_patch.js
