...
gamification_karma_rank_access_user_manager,gamification.karma.rank.access.user.manager,gamification.model_gamification_karma_rank,base.group_erp_manager,1,1,1,1
        ...
        <field name="arch" type="xml">
            <form string="Goal definitions">
                <sheet>
                        ...
                        <group string="How to compute the goal?" name="compute_details">
                        ...
                        <group string="Formating Options" name="format_options">
