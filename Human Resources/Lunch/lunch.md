...
## File: report\lunch_product_report.py
...
lunch_product_report_user,access_lunch_product_report,model_lunch_product_report,group_lunch_user,1,1,0,0
...
## File: static\src\js\lunch_kanban_mobile.js
...
## File: static\src\js\lunch_kanban_model.js
...
## File: static\src\js\lunch_kanban_widget.js
    ...
    <div t-name="LunchPreviousOrdersWidgetList" class="row">
        <div t-foreach="categories" t-as="supplier" class="col-lg-4">
            ...
            <div t-foreach='categories[supplier]' t-as='order' class="o_lunch_vignette">
                <button type="button" class="float-right o_add_button oe_edit_only btn-link border-0" t-att-data-id="order.line_id">
...
## File: static\src\xml\lunch_kanban.xml

```xml
<?xml version="1.0" encoding="UTF-8"?>
<templates>
    <span t-name="LunchKanbanWidget">
        ...
        <div class="o_lunch_kanban_banner container-fluid">
                ...
                <templates>
                    <t t-name="kanban-box">
                        <div class="oe_kanban_global_click o_kanban_record_has_image_fill o_kanban_record">
                            <field name="image_128" class="o_lunch_image o_kanban_image_fill_left d-none d-md-block" options="{'placeholder': '/lunch/static/img/lunch.png'}" widget="image"/>
...
## File: wizard\lunch_line_wizard.py
...
## File: wizard\lunch_line_wizard_views.xml
