    ...
    <record id="lunch_order_view_tree" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <tree string="Order lines Tree" create="false" edit="false" decoration-muted="state == 'cancelled'" expand="1">
                ...
                <button name="action_reorder" string="Re-order" type="object" icon="fa-history" invisible="not display_reorder_button" groups="lunch.group_lunch_user"/>
    ...
    <record id="lunch_order_view_form" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <form class="flex-column">
                ...
                <footer>
                    <button string="Add To Cart" name="add_to_cart" type="object" class="oe_highlight" invisible="order_deadline_passed" data-hotkey="w"/>
