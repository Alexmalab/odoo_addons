...
class FleetVehicleLogContract(models.Model):
    ...
    @api.depends('vehicle_id.name', 'cost_subtype_id', 'date')
...
<odoo>
    ...
    <menuitem action="fleet_vehicle_model_action" parent="fleet_vehicles" id="fleet_vehicle_model_menu" sequence="11"/>
