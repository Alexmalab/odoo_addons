...
## File: models\fleet_vehicle_cost.py
...
<odoo>
    ...
    <record id='fleet_vehicle_view_tree' model='ir.ui.view'>
        ...
        <field name="arch" type="xml">
            <tree string="Vehicle" 
                ...
                <field name="vin_sn"/>
                <field name="co2" string="CO2 Emissions g/km" optional="hide" />
    ...
    <record id="fleet_vehicle_view_search" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <search string="All vehicles">
                ...
                <filter name="planned" string="Planned for Change" domain="[('plan_to_change_car', '=', True)]"/>
                <separator/>
    ...
    <menuitem action="fleet_vehicle_action" parent="fleet_vehicles" id="fleet_vehicle_menu" groups="fleet_group_user" sequence="1"/>
                    ...
                    <div class="app_settings_block" data-string="Fleet" id="fleet" string="Fleet" data-key="fleet" groups="fleet.fleet_group_manager">
                        ...
                        <div class="row mt16 o_settings_container" id="end_contract_setting">
                            ...
                            <div class="col-12 col-lg-6 o_setting_box" invisible="1">
                                <div class="o_setting_left_pane">
                                    <field name="module_fleet_account" widget="upgrade_boolean"/>
                                </div>
                                <div class="o_setting_right_pane">
